...
def serializedATN():
    return [
        ...
        2,1,0,0,0,27,28,5,42,0,0,28,4,1,0,0,0,29,30,5,43,0,0,30,6,1,0,0,
        0,31,32,5,45,0,0,32,8,1,0,0,0,33,34,5,40,0,0,34,10,1,0,0,0,35,36,
        5,41,0,0,36,12,1,0,0,0,37,38,5,91,0,0,38,14,1,0,0,0,39,40,5,44,0,
        0,40,16,1,0,0,0,41,42,5,93,0,0,42,18,1,0,0,0,43,47,7,0,0,0,44,46,
...
class GramaticaMatricesLexer(Lexer):
